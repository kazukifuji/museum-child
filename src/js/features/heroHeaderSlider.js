...
//ヒーローヘッダーのスワイパーコンテナー要素
const swiperContainer = document.querySelector('#heroHeader .swiper-container');
...
export default {
  ...
  implement: () => {
    ...
    swiper = new Swiper( swiperContainer, {
      ...
      on: {
        ...
        resize: () => {
          objectFitPolyfill( swiper.el.querySelectorAll('.swiper-slide > img') );
        },
    ...
    if ( swiper.slides.length <= 1 ) {
      ...
      swiperContainer.querySelector('.swiper-pagination').style.display = 'none';
    }
  },
  ...
  play: () => {
    ...
    swiper.slides[0].children[0].style.animation = 'zoom-out 10s cubic-bezier(0.5, 1, 0.89, 1) both';
  },
